...
\champnom{".chr(92).chr(102)."box{
		...
		$fichier=fopen('/home/groupe4/'.$nomQCM.'.txt','r+');	//Ouvre
			fseek ($fichier, 188);			//Position du poiteur
			fwrite($fichier, $exemplaire);	//nb exemplaire
			
			fseek ($fichier, 353);			//Position du poiteur
			fwrite($fichier, $dateexam);	//date
			
			fseek ($fichier, 637);			//Position du poiteur
		...
		for ($i=0; $i<$nbQuestion; $i++){
			...
			$bar1=$_SESSION['bar'.$i.'1'];
			$bar2=$_SESSION['bar'.$i.'2'];
			$bar3=$_SESSION['bar'.$i.'3'];
			$bar4=$_SESSION['bar'.$i.'4'];
			echo $bar1;
			if ($check1 == 'on'){
			...
			if ($cptRep>1){
				$nbRep="\begin{questionmult}{prez}";
			}
			else{
				$nbRep="\begin{question}{pref}";
			}
...
/*	exec ("cp /home/groupe4/".$nomQCM.".txt /home/groupe4/".$nomQCM.".tex");
	...
	exec ("mkdir /home/groupe4/Fichiers/".$nomQCM."");
	exec ("mv /home/groupe4/amc-compiled.* /home/groupe4/Fichiers/".$nomQCM."");
	exec ("mv /home/groupe4/".$nomQCM.".tex /home/groupe4/Fichiers/".$nomQCM."");	
	exec ("cp /home/groupe4/Fichiers/".$nomQCM."/amc-compiled.pdf /home/groupe4/Fichiers/".$nomQCM."/".$nomQCM.".pdf");		
	exec ("chmod +x /home/groupe4/Fichiers/".$nomQCM."/".$nomQCM.".pdf");
	exec ("cd /home/groupe4/Fichiers/".$nomQCM."");
...
*/
        ...
        exec ("./home/groupe4/new_project.sh ".$_SESSION['mail']." ".$nomQCM."");
