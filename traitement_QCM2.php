...
%%% debut de l'en-tete de la feuille de reponses

{\large\bf Feuille de reponses :}
...
\begin{center}
  \bf".chr(92).chr(101)."m Les reponses aux questions sont a donner exclusivement sur cette feuille :
  les reponses donnees sur les feuilles precedentes ne seront pas prises en compte.
".chr(92).chr(101)."nd{center}
%%% fin de l'en-tete de la feuille de reponses
