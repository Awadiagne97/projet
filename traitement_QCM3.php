...
".chr(92).chr(101)."nd{document}";
    ...
    exec ("auto-multiple-choice prepare --mode b --prefix /home/groupe4/Fichiers/".$_SESSION['mail']."/".$nomQCM."/ /home/groupe4/Fichiers/".$_SESSION['mail']."/".$nomQCM."/".$nomQCM.".tex --data /home/groupe4/Fichiers/".$_SESSION['mail']."/".$nomQCM."/data/");
    exec ("auto-multiple-choice meptex --src /home/groupe4/Fichiers/".$_SESSION['mail']."/".$nomQCM."/amc-compiled.xy --data /home/groupe4/Fichiers/".$_SESSION['mail']."/".$nomQCM."/data");
